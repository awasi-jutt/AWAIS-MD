...
cmd({  
  ...
  try {  
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/awasi-jutt/AWAIS-MD/commits/main");  
    ...
    if (latestCommitHash === currentHash) {  
      return reply("```✅ Your AWAIS-MD bot is already up-to-date!```\n");  
    }  
    ...
    const { data: zipData } = await axios.get("https://github.com/awasi-jutt/AWAIS-MD/archive/main.zip", { responseType: "arraybuffer" });  
