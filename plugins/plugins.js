...
const REPO_OWNER = 'awasi-jutt';
const REPO_NAME = 'AWAIS-MD';
...
async (conn, mek, m, { from, reply }) => {
    try {
        ...
        let pluginList = "📂 *AWAIS MD V1 PLUGINS:*\n\n";
...
async (conn, mek, m, { from, reply, args, senderNumber }) => {
    try {
        ...
        if (m.quoted && m.quoted.key.fromMe) {
            ...
            if (/📂 \*AWAIS MD V1 PLUGINS:\*/i.test(quotedText)) {
        ...
        const statusMessage = {
            image: { url: `https://i.ibb.co/Z6Mf1mWt/shaban-md.jpg` }, // Replace with your image URL
