...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "923146375610@s.whatsapp.net", // Replace with staff contact numbers
                "923146375610@s.whatsapp.net", // Example: Add staff members here
                "923146375610@s.whatsapp.net", // Example: Add staff members here
                "923146375610@s.whatsapp.net", // Example: Add staff members here
                "923146375610@s.whatsapp.net", // Example: Add staff members here
                "923146375610@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "•𝐀𝐖𝐀𝐈𝐒 𝗝𝐔𝐓𝐓⁶¹⁰";
            const imageUrl = "https://i.ibb.co/Z6Mf1mWt/shaban-md.jpg"; // Replace with the actual image URL
